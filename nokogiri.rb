...
page1 = HTTParty.get('https://www.airbnb.com/s/Amsterdam')
...
page2 = HTTParty.get('https://www.airbnb.com/s/Amsterdam?page=2')
...
page3 = HTTParty.get('https://www.airbnb.com/s/Amsterdam?page=3')
...
page4 = HTTParty.get('https://www.airbnb.com/s/Amsterdam?page=4')
