...
page1 = HTTParty.get('http://www.hostelworld.com/hostels/Bangkok')
...
page2 = HTTParty.get('http://www.hostelworld.com/hostels/Bangkok?page=2')
...
page3 = HTTParty.get('http://www.hostelworld.com/hostels/Bangkok?page=3')
