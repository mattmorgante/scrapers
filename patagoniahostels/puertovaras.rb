...
page1 = HTTParty.get('http://www.hostelworld.com/hostels/puerto-varas')
...
page2 = HTTParty.get('http://www.hostelworld.com/hostels/puerto-varas?page=2')
...
page3 = HTTParty.get('http://www.hostelworld.com/hostels/puerto-varas?page=3')
...
CSV.open('puertovaras.csv', 'w') do |csv|
  csv << prices_array
end 
