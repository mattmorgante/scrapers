...
page1 = HTTParty.get('http://www.hostelworld.com/hostels/el-bolson')
...
page2 = HTTParty.get('http://www.hostelworld.com/hostels/el-bolson?page=2')
...
page3 = HTTParty.get('http://www.hostelworld.com/hostels/el-bolson?page=3')
...
CSV.open('elbolson.csv', 'w') do |csv|
  csv << prices_array
end 
