...
page1 = HTTParty.get('http://www.hostelworld.com/hostels/puerto-natales')
...
page2 = HTTParty.get('http://www.hostelworld.com/hostels/puerto-natales?page=2')
...
page3 = HTTParty.get('http://www.hostelworld.com/hostels/puerto-natales?page=3')
...
CSV.open('puerto-natales.csv', 'w') do |csv|
  csv << prices_array
end 
