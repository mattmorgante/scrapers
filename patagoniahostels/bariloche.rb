...
page1 = HTTParty.get('http://www.hostelworld.com/hostels/bariloche')
...
page2 = HTTParty.get('http://www.hostelworld.com/hostels/bariloche?page=2')
...
page3 = HTTParty.get('http://www.hostelworld.com/hostels/bariloche?page=3')
...
CSV.open('bariloche.csv', 'w') do |csv|
  csv << prices_array
end 
