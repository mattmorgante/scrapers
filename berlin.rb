...
page1 = HTTParty.get('http://www.hostelworld.com/hostels/Berlin')
...
page2 = HTTParty.get('http://www.hostelworld.com/hostels/Berlin?page=2')
...
page3 = HTTParty.get('http://www.hostelworld.com/hostels/Berlin?page=3')
